const books = [
  ...
  },
  {
    ...
    level: 'Middle',
    tags: ['core', 'frontend', 'javascript', 'testing'],
    amount: 42,
    shortDescription:
  ...
  },
  {
    ...
    level: 'Beginner',
    tags: ['core', 'frontend', 'javascript', 'angular'],
    amount: 42,
    shortDescription:
  ...
  },
  {
    ...
    amount: 42,
    shortDescription:
      'Web apps would run much better if heavy calculations could be performed in the background, rather than compete with the user interface.',
    description:
  ...
  },
  {
    ...
    level: 'Pro',
    tags: ['core', 'frontend', 'javascript', 'ajax'],
    amount: 42,
    shortDescription:
  ...
  },
  {
    ...
    price: 41.89,
    image:
      'https://courses.prometheus.org.ua/asset-v1:Ciklum+FEB101+2022_T3+type@asset+block@node_for_front_end_developers.jpg',
    title: 'Node for Front-End Developers',
    level: 'Middle',
    tags: ['core', 'node', 'frontend'],
    amount: 42,
    shortDescription:
